...
const Login = () => {
    ...
    return (
        ...
        //     <h1 className='text-white text-3xl font-bold mt-10'>Login</h1>
        //     <div className='flex-col flex flex-1 container justify-center items-center mb-10 rounded-lg shadow-lg'>
        //         <h2 className='font-bold text-white'>Already a user! Login..</h2>
        ...
        //         </form>
        //         <p className='text-slate-100'>Don't have an account? <a className='hover:text-slate-300 hover:underline' href="/signup">SignUp</a></p>
        //     </div>
        // </div>
    )
}
